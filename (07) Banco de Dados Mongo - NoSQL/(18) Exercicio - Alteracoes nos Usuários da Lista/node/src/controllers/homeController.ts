...
export const home = async(req: Request, res: Response) => { 
    ...
    //await User.findOneAndDelete({ email: 'teste@op.com' })

    /*let teach = await User.findOne({ email: 'teach@op.com' })
    if(teach) {
        await teach.remove() // QUando se quer remover atravez de um OBJ se usa REMOVE
    }*/
